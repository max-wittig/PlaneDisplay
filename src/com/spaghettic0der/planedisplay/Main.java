...
import com.spaghettic0der.planedisplay.Logic.Style;
...
public class Main extends Application
{
    ...
    public void start(Stage primaryStage) throws Exception
    {
        ...
        planeDisplay.show("It is a long established fact that a reader will be distracted by the readable content", 10, Style.RANDOM);
